...
options validation, raid assignments, group roles, talent caching, load conditions, talent triggers, taxi/vehicle conditions, PvP flags, ruleset migration, instance filters, restricted character stats, and threat filters. Picker checks
