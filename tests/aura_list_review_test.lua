...
T.section("Context menu dispatch")
options.RevealDisplay("Renamed")
...
T.expect(fixture.menu[#fixture.menu].text=="Close","right-click dispatch opens the display button menu")
T.expect(#fixture.errors==0,"display button menu dispatch reports no errors")
T.finish()
